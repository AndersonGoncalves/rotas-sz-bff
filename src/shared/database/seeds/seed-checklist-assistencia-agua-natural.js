...
async function main() {
  ...
  if (items.length === 0) {
    console.log('Nenhum checklist de assistência água natural novo para inserir.');
    return;
  }
  console.log(`Enviando ${items.length} checklist(s) de assistência água natural para ${BASE_URL}\n`);
