    ...
    schemas: {
      ...
      Pedido: {
        ...
        properties: {
          ...
          index: { type: 'integer' },
          horarioPrevistoAtendimento: { type: 'string', format: 'date-time', nullable: true },
          distanciaPercorridaMetros: { type: 'integer', nullable: true },
          duracaoPercorridaSegundos: { type: 'integer', nullable: true },
          horarioInicioReal: { type: 'string', format: 'date-time', nullable: true },
          horarioFimReal: { type: 'string', format: 'date-time', nullable: true },
          origemRoteirizacao: { type: 'string', nullable: true },
          destinoRoteirizacao: { type: 'string', nullable: true },
          origemDiaRoteirizacao: { type: 'string', nullable: true },
