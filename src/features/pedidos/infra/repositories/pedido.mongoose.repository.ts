...
export class PedidoMongooseRepository implements IPedidoRepository {
  private toEntity(doc: any): IPedido {
    return {
      ...
      index: doc.index,
      horarioPrevistoAtendimento: doc.horarioPrevistoAtendimento,
      distanciaPercorridaMetros: doc.distanciaPercorridaMetros,
      duracaoPercorridaSegundos: doc.duracaoPercorridaSegundos,
      ...
      origemDiaRoteirizacao: doc.origemDiaRoteirizacao,
      cliente: doc.cliente,
